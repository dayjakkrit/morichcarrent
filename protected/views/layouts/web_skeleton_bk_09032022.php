...
<body>
                     ...
                     <div class="col-md-3">
                        <div class="header-top-right">
                           ...
                           <?php //}else{ ?>
                              ...
                              <a href="javascript:openModal('Sing In','singin');"><i class="fa fa-key"></i> Sing In</a>| <a href="javascript:openModal('Register','register');" class="ml-2"><i class="fa fa-user"></i> Register</a>
                           <?php //}?>
                        </div>
                     </div>
                  </div>
  ...
  <script>
	$(document).ready(function() {
		...
		$("#car_offer_price").load("<?php echo Yii::app()->createAbsoluteUrl('site/showcarofferprice'); ?>");
		...
		$("#contact_us").load("<?php echo Yii::app()->createAbsoluteUrl('site/showcontactus'); ?>");
		$("#booking").hide();
		
		//$("#am1").load("<?php echo Yii::app()->createAbsoluteUrl('site/loadsingin01'); ?>");
		//$("#am2").load("<?php echo Yii::app()->createAbsoluteUrl('site/loadregis01'); ?>");
		
	});
	
	function showbooking(){
		$("#booking").load("<?php echo Yii::app()->createAbsoluteUrl('site/showbooking'); ?>");
		$("#booking").fadeOut(400);
		$("#booking").fadeIn(800);
	...
	function test(){
		alert("test test");
		$("#regis_01").load("<?php echo Yii::app()->createAbsoluteUrl('site/loadregis01'); ?>");		
	}
	...
	function openModal(hdn,pn){
		...
		$("#bdm_01").load("<?php echo Yii::app()->createAbsoluteUrl('site/loadsingin01'); ?>");
	}
